...
import asboot.auth.authentication.DeviceClientAuthenticationProvider;
import asboot.auth.federation.FederatedIdentityIdTokenCustomizer;
import asboot.auth.jose.Jwks;
import asboot.auth.web.authentication.DeviceClientAuthenticationConverter;
